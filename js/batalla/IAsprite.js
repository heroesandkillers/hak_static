...
var animation = {
    ...
    animacionFlecha: function(inicialX, inicialY, terminoX, terminoY) {
        ...
        flechaImg.src = org + 'img/canvas/flecha.png';
...
//        batalla.stage.addChild(magia);
        ...
        var image = new Image();
        image.src = org + "img/canvas/magiaFuego.png";
        var Animaciones = {
            images: [image],
    ...
    efectoAnimado: function(efecto, rgEfecto) {
        ...
        if (grupo.getChildByName(efecto) === null) {
            ...
            var image = new Image();
            image.src = org + "img/canvas/efecto" + efecto + ".png";
    ...
    explosionMagia: function(x, y) {
        var image = new Image();
        image.src = org + "img/canvas/explosionMagia.png";
    ...
    finSalto: function() {
        var grupo = this.grupo;
        var image = new Image();
        image.src = org + "img/canvas/finSalto.png";
    ...
    nova: function() {
        ...
        var image = new Image();
        image.src = org + "img/canvas/nova" + elemento + ".png";
    ...
    curar: function() {
        var grupo = this.grupo;
        var image = new Image();
        image.src = org + "img/canvas/curar.png";
    ...
    flechaBack: function(objetivoX, objetivoY) {
        ...
        var image = new Image();
        image.src = org + "img/canvas/flechaBack.png";
...
function IAfin(stats) {
    ...
    if (animation.grupo &&
            !animation.grupo.getChildByName('subgrupo').visible
